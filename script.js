...
const translations = {
  th: {
    ...
    heroLocation: 'สุโขทัย · อุตรดิตถ์, ประเทศไทย',
    ...
    resumeLocation: 'สุโขทัย · อุตรดิตถ์, ประเทศไทย',
  ...
  en: {
    ...
    heroLocation: 'Sukhothai · Uttaradit, Thailand',
    ...
    resumeContactTitle: 'CONTACT',
    resumeLocation: 'Sukhothai · Uttaradit, Thailand',
